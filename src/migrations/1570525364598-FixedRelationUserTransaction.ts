...
export class FixedRelationUserTransaction1570525364598 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query("ALTER TABLE `transaction` ADD `userId` int NULL", undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `transaction` DROP COLUMN `userId`", undefined);
    }
